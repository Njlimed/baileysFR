...
export declare const makeMessagesRecvSocket: (config: SocketConfig) => {
    ...
    relayMessage: (jid: string, message: proto.IMessage, { messageId: msgId, participant, additionalAttributes, additionalNodes, useUserDevicesCache, useCachedGroupMetadata, statusJidList, cachedGroupMetadata }: MessageRelayOptions) => Promise<string>;
