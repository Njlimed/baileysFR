...
declare const makeWASocket: (config: UserFacingSocketConfig) => {
    ...
    relayMessage: (jid: string, message: import("../Types").WAProto.IMessage, { messageId: msgId, participant, additionalAttributes, additionalNodes, useUserDevicesCache, useCachedGroupMetadata, statusJidList, cachedGroupMetadata }: import("../Types").MessageRelayOptions) => Promise<string>;
    sendReceipt: (jid: string, participant: string | undefined, messageIds: string[], type: import("../Types").MessageReceiptType) => Promise<void>;
    getButtonArgs: (message: import("../Types").WAProto.IMessage) => import("..").BinaryNode;
    ...
    sendStatusMentions: (content: import("../Types").AnyMessageContent, jids?: string[], opts?: {
        tag?: boolean;
    ...
    newsletterWMexQuery: (jid: string | undefined, queryId: import("../Types").QueryIds, content?: object) => Promise<any>;
