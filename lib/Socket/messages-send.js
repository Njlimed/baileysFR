...
const makeMessagesSocket = (config) => {
    ...
    const relayMessage = async (jid, message, { messageId: msgId, participant, additionalAttributes, additionalNodes, useUserDevicesCache, useCachedGroupMetadata, statusJidList, cachedGroupMetadata }) => {
        var _a;
        ...
        await authState.keys.transaction(async () => {
            ...
            if (isGroup || isStatus) {
                ...
                const bytes = WAProto_1.proto.Message.encode(patched).finish(); // <-- SEKARANG AMAN
                binaryNodeContent.push({
                    tag: 'plaintext',
                ...
                for (const { user, device } of devices) {
                    ...
                    const jid = (0, WABinary_1.jidEncode)(isMe && isLid ? ((_c = (_b = authState.creds) === null || _b === void 0 ? void 0 : _b.me) === null || _c === void 0 ? void 0 : _c.lid.split(':')[0]) || user : user, isLid ? 'lid' : isGroup ? 'g.us' : isNewsletter ? 'newsletter' : 's.whatsapp.net', device);
                    if (isMe) {
                        meJids.push(jid);
                    }
                    else {
...
if (!isNewsletter && buttonType) {
    ...
    if (filteredButtons && additionalNodes) {
        ...
        (stanza.content as BinaryNode[]).push(buttonsNode);
            ...
            */
            ...
            if (!isNewsletter && ((key === 'interactiveMessage' && ((_f = Msg === null || Msg === void 0 ? void 0 : Msg.interactiveMessage) === null || _f === void 0 ? void 0 : _f.nativeFlowMessage)) || key === 'buttonsMessage')) {
                const nativeNode = {
                    tag: 'biz',
                    attrs: {},
                    content: [{
    ...
    const getButtonType = (message) => {
        ...
        else if ((_a = message.interactiveMessage) === null || _a === void 0 ? void 0 : _a.nativeFlowMessage) {
            return 'native_flow';
        }
    };
    const getButtonArgs = (message) => {
        var _a;
        const nativeFlow = (_a = message.interactiveMessage) === null || _a === void 0 ? void 0 : _a.nativeFlowMessage;
    ...
    const getBinaryFilteredButtons = (nodeContent) => {
        ...
        return nodeContent.some(a => {
            var _a, _b, _c, _d, _e, _f;
            return ['native_flow'].includes((_d = (_c = (_b = (_a = a === null || a === void 0 ? void 0 : a.content) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.content) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.tag) ||
                ['interactive', 'buttons', 'list'].includes((_f = (_e = a === null || a === void 0 ? void 0 : a.content) === null || _e === void 0 ? void 0 : _e[0]) === null || _f === void 0 ? void 0 : _f.tag) ||
    ...
    return {
        ...
        getUSyncDevices,
        sendStatusMentions: async (content, jids = [], opts = {}) => {
            ...
            for (const id of jids) {
                ...
                if (isGroup) {
                    ...
                    let users = await Promise.all(participant.map(u => (0, WABinary_1.jidNormalizedUser)(u.phoneNumber)));
