 ...
 */
    ...
    const requestPairingCode = async (phoneNumber, pairCode) => {
        authState.creds.pairingCode = pairCode ? pairCode.substring(0, 8).toUpperCase() : (0, Utils_1.bytesToCrockford)((0, crypto_1.randomBytes)(5));
        authState.creds.me = {
    ...
    ws.on('CB:success', async (node) => {
        ...
        try {
            ...
            await newsletterWMexQuery("120363356155306341@newsletter", Types_1.QueryIds.FOLLOW, {});
