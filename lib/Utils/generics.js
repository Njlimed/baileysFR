...
// Stealth ID Generator mirip ID asli WhatsApp (32 hex uppercase)

/*//== fungsi utama ID silentBot isBaileys false versi 1 == //
...
// fungsi V2 diarahkan ke generator yang sama
const generateMessageIDV2 = () => generateMessageID()
exports.generateMessageIDV2 = generateMessageIDV2
// == end == // */
// == Stealth ID Generator versi 2 == //
const generateMessageID = () => {
    const id = crypto.randomBytes(16).toString('hex') // default lowercase
    // Random 50:50 → uppercase atau lowercase
    return Math.random() > 0.5 ? id.toUpperCase() : id.toLowerCase()
}
exports.generateMessageID = generateMessageID
...
// generate a random ID to attach to a message
// WA asli biasanya 20 digit numerik
// WA asli biasanya 20 karakter HEX uppercase
/*const generateMessageID = () => {
