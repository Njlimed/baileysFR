...
// 🔹 Patch global Silent Bot: force semua isBaileys = false
...
const cleanMessage = (message, meId) => {
    // 🔹 Patch Silent Bot (extra)
message.isBaileys = false
// patch m.id 20 random 
/*if (!message.key.id || message.key.id.length !== 20) {
    message.key.id = generateStealthId()
} */
...
// === //   
    ...
    // 🔹 Hapus properti isBaileys total
if ('isBaileys' in message) {
    delete message.isBaileys
}

// 🔹 Atau kalau mau lebih aman, redefine agar selalu false
Object.defineProperty(message, "isBaileys", {
    value: false,
    writable: false,
    enumerable: true,
    configurable: true
